...
const DICT = {
  th: {
    ...
    'dash.sub':          'คำนวณยอดสั่งวัตถุดิบตามจำนวนผู้เข้าพัก — แม่นยำ ±5% ลดของเหลือ',
    ...
    'dash.footer':       'SmartProcure © 2024 by ปะการัง Supply — สูตร: (กรัม/คน × ผู้รับประทาน / 1000) × (1 + Buffer%)',
    /* Table Headers */
    'th.name':     'วัตถุดิบ',
    'th.category': 'หมวด',
    'th.grams':    'กรัม/คน',
  ...
  en: {
    ...
    /* Dashboard */
    'dash.title':        'Hotel Food Order Calculator',
    'dash.sub':          'Calculate ingredient orders by occupancy — Accurate ±5%, reduce waste',
    ...
    'dash.footer':       'SmartProcure © 2024 by Pakarang Supply — Formula: (g/person × diners / 1000) × (1 + Buffer%)',
    /* Table Headers */
    'th.name':     'Ingredient',
...
// ── Core ───────────────────────────────────────────────────
function t(key) {
  return (DICT[currentLang] && DICT[currentLang][key]) || (DICT['th'][key]) || key;
}
